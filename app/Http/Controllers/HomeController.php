...
//home page data
    ...
    public function index()
    {
     ...
     //   ->select('products.*')->get();
      ...
      ->select('products.*', 'prices.price as price_name','countries.name as country_name', 'states.name as state_name', 'cities.name as city_name', 'streets.name as street_name'
    ...
    //   ->select('prices.price as price_name')->get();
    //   $types = DB::table('types')
    //   ->select('typess.name as type_name')->get();
       //return $products;

      return view('home.home',compact('sub_category','sliders','products','city','header','category','price','types'));
    }
